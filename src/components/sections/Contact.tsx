...
import { ArrowUpRight, FileText, GitFork, Briefcase } from "lucide-react";
...
const TILES = [
  { label: "GitHub", href: profile.github, icon: GitFork, external: true },
  { label: "LinkedIn", href: profile.linkedin, icon: Briefcase, external: true },
